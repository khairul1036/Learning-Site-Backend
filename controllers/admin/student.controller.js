...
exports.findStudent = async (req, res) => {
  ...
  try {
    const student = await Student.findOne({ sid }).select("-password")
...
exports.deleteStudent = async (req, res) => {
  ...
  try {
    const findUser = await Student.findOneAndDelete({ sid }).select("-password")
...
exports.updateStudent = async (req, res) => {
  ...
  try {
    ...
    return updateStudent
      ? res
        .status(200)
        .json({ status: true, message: "Updated Student successfully", student: updateStudent })
      : res
        .status(404)
